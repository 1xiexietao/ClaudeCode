---
name: create-prd
description: 根据业务上下文生成结构化 B端 PRD 文档，涵盖14个标准章节，支持产品定型、Mermaid图表生成
---
...
| 迭代/模块级需求 | 第1-2章简化为变更背景、第3章可省略、第5-7章聚焦变更范围、第10章聚焦变更模块、第11章只更新受影响的权限 |
...
## create-prd-ch11-permissions

# 第11章 角色和权限 — 生成指引

> 生成 PRD 第11章"角色和权限"的指引文件。
...
PRD 初稿生成后，按照 Check-PRD 的12个维度进行快速扫描，标注哪些地方需要用户进一步补充和完善。这不是完整评审，而是"生成后质量门禁"。
